# 这是使用前，一些作者想要告诉你的事情，如果有耐心，希望你能看完，包含无法在论文原文中说明的一些细节，文末最后有网络引入的代码供你使用
# 这是贴主截止硕士毕业的唯一一篇一作小论文，在很多数据集上的指标并不算优秀，训练和检验框架请参考UDTransNet那个文章，我觉得那个文章的代码框架是不错的（利益无关）

# 如果需要我的权重请评论区联系我，或者有什么问题或者质疑或者需要代码片段都可以联系我，我觉得无所谓，但**不想公开，可私下获取，可免费远程指导复现
...
# 如果有什么问题，可以直接中文向我提问，因为我是中国人，国人之间用英文交流浪费沟通成本
# But if you're a foreigner, you can communicate with me in English, or in any other language that AI understands.
# 希望你能做出更有意义的科研
# TUTNet
torch >= 2.0.0
cuda >= 11.8
